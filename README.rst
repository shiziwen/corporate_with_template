...
2. Get the code::
    ...
    $ git clone ssh://git@bitbucket.org/maykinmedia/maykinmedia.git
    $ cd maykinmedia
...
``src/maykinmedia/conf/settings_local.py``. You can base this file on
...
Note that your wsgi script in ``src/maykinmedia/wsgi.py already
